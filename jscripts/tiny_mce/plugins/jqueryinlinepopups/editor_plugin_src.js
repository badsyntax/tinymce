	...
	tinymce.create('tinymce.plugins.jQueryInlinePopups', {
		...
		getInfo : function() {
			return {
				...
				infourl : 'http://wiki.moxiecode.com/index.php/TinyMCE:Plugins/jqueryinlinepopups',
...
//			f.top -= po.y;
			...
			t._addAll(DOM.doc.body, 
				['div', {id : id, 'class' : ed.settings.jqueryinlinepopups_skin || 'clearlooks2', style : 'width:100px;height:100px'}, 
			...
			if (t.count == 0 && t.editor.getParam('dialog_type', 'modal') == 'modal') {
				DOM.add(DOM.doc.body, 'div', {
					id : 'mceModalBlocker',
					'class' : (t.editor.settings.jqueryinlinepopups_skin || 'clearlooks2') + '_modalBlocker',
...
//			cp = DOM.getPos(t.editor.getContainer());
			...
			function startMove() {
				...
				DOM.add(d.body, 'div', {
					id : 'mceEventBlocker',
					'class' : 'mceEventBlocker ' + (t.editor.settings.jqueryinlinepopups_skin || 'clearlooks2'),
					style : {zIndex : t.zIndex + 1}
				});
